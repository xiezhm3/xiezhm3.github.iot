...
#### 045 讲 没有使用需求就没有投资需求 [2019-04-20]

`空置率不可能客观衡量与计算。很多人都有这个想法，说市场上很多房子是空置的，因此可以通过收空置税的方式，让人们不敢囤积房子。但是仔细想想，空置率是没办法客观计算的，想想，我有两套50平的房子和有一套100平的房子，50平的房子已经满足我的需求了，所以可以肯定，另外的一套房子就是空置的了；但是假如我一个人住100平，有一半的空间我是没有使用的，这个时候空置率能计算出来吗？而实际上，当市场价格合适的时候，把其中一套50平的出租出去的可能性比把100平的房子要更大，对市场有效配置住房资源的贡献就更大。但是如果征收空置税，人们就会争着去买大房子。而且即使征收空置税，人们也有应对的办法。如何才能确定是空置的呢？看水表还是电表？这样就会平添新的职业，像遛狗一样遛房子。所以空置税起不到任何实际效果，只会扭曲市场对房型设计的实际需求。`

`使用需求是投资需求的基础。实际上所有的投资需求，都是以实际使用需求为基础的。没有实际使用的需求，就不会有投资需求。给我们块烂地，我们会去炒吗？当然不会。如果硬要把使用需求和投资需求区分开，对立起来的话，就不会有人投资，就不会产生满足未来市场需求的供给。几年以后，新的房源就会萎缩；长此以往，居住条件就会变得更差，而不会变得更好。`


### 第046讲 权利有别于能力 [4.21]

`迂回竞争带来了巨大的财富。让人类有别于动物，长期展开迂回竞争，从而积累大量财富的原因之一，是人类社会逐渐建立起了精致的权利体系。权利保护了有效的竞争。`

`“产权是一种通过社会强制而实现的，对某种经济物品的多种用途进行选择的权利。”权利是通过社会强制而实现的，是别人授予我们的；不是我们自己认为有就有，而是别人认为我们有才有；要别人愿意出来保护我们行使的权利，才能叫权利。这是权利的特征。`
